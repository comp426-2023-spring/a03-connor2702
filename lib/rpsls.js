export function rps(shot) {
    ...
    if (shot == rock) {
        const winlosetie = rock_results[opshot];
    }
    if (shot == paper) {
        const winlosetie = paper_results[opshot];
    }
    if (shot == scissors) {
        const winlosetie = scissors_results[opshot];
    }
...
export function rpsls(shot) {
    ...
    if (shot == lizard) {
        const winlosetie = lizard_results[opshot];
    }
    if (shot == spock) {
        const winlosetie = spock_results[opshot];
    }
